...
const SOURCE_DEFINITIONS = {
  ...
  crunchyrollnews: {
    ...
    collectionPriority: ["home", "sitemap"],
    enableSitemap: false,
  ...
  nintendolife: {
    ...
    sitemapIndexUrl: "https://www.nintendolife.com/sitemap.xml",
  ...
  aftermath: {
    ...
    excludedPathPrefixes: [
      ...
      "/tip-jar",
      "/gift-subscription",
      "/aftermath-group-institutional-subscription-deal",
      "/aftermath-freelance-pitch-guide",
      "/aftermath-rss-feed",
      "/latest",
      "/commenting-policy",
      "/52-pickup",
      "/aftermath-site-subscriber-goals",
      "/aftermath-subscriber-goals",
      "/thank-you",
    ],
